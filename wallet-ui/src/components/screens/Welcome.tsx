...
export function Welcome({ onNext, onNavigateToHome }: WelcomeProps) {
  ...
  // Update the handleSignIn function in Welcome.tsx
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      console.log("Campus name from response:", response.campusName);

      // Store token
      localStorage.setItem("authToken", response.token);

      // Store COMPLETE user data including campusName
      const userData = {
        id: response.userId,
        ...
        campusName: response.campusName, // CRITICAL: Store campus name!
      };
      ...
      // Navigate based on role with custom event
      // App.tsx is already listening for this event
      console.log("Dispatching navigation event for role:", response.role);

      let targetScreen = "home"; // default

      if (response.role === "ADMIN") {
        targetScreen = "admin";
        console.log("✅ Will navigate to admin panel");
      } else if (response.role === "MERCHANT") {
        targetScreen = "merchant";
        console.log("✅ Will navigate to merchant dashboard");
      } else {
        targetScreen = "home";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-blue-900 flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <div className="pt-16 px-6 text-center">
          ...
          <p className="text-sm text-indigo-300/80">
            Global Financial Solutions for Students
          </p>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-indigo-200 text-sm leading-relaxed">
                    Seamlessly manage USD, EUR, GBP, JPY, and INR with real-time
                    exchange rates
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-5 hover:bg-white/15 transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-indigo-200 text-sm leading-relaxed">
                    256-bit encryption and secure authentication keep your funds
                    safe
                  </p>
                </div>
              </div>
